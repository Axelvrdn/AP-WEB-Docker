...
function selectionnerSecteur(nomSecteur) {
    ...
    fetch('../Get/get_traversees.php?nom_secteur=' + encodeURIComponent(nomSecteur))
    ...
    fetch('../Get/get_infos.php?nom_secteur=' + encodeURIComponent(nomSecteur))
        .then(response => response.json())
        .then(data => {
...
function selectionnerTraversee(descTravers) {
    ...
    fetch('../Get/get_dates.php?desc_travers=' + encodeURIComponent(descTravers))
        .then(response => response.json())
        .then(data => {
    ...
    fetch('../Get/get_infos.php?nom_secteur=' + encodeURIComponent(secteurSelectionne) + '&desc_travers=' + encodeURIComponent(descTravers))
        .then(response => response.json())
        .then(data => {
            let tbody = document.querySelector('tbody');
            tbody.innerHTML = ""; // Nettoie l'ancienne table
...
function selectionnerDate(dateTravers) {
    ...
    fetch(`../Get/get_infos.php?nom_secteur=${encodeURIComponent(secteurSelectionne)}&desc_travers=${encodeURIComponent(descTravers)}&date_travers=${encodeURIComponent(dateTravers)}`)
        .then(response => response.json())
        .then(data => {
            let tbody = document.querySelector('tbody');
