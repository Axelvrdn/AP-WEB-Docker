...
<html lang="fr">
  ...
  <body>
    ...
    <section class="connexion">
        ...
        <br><br>
        <form action="confirmation.php" method="POST" id="leForm"> <!-- Action vers le même fichier pour traitement -->
            ...
            <div class="form-group">
                ...
                <select id="bateau" name="bateau" >
                  <option value="">--Choisissez un bateau--</option>
                  <?php if($bateaux !== null) : ?>
                      <?php foreach($bateaux as $bateau) : ?>
                          <option value="<?php echo $bateau['nom_bateau']; ?>" name="bateau"><?php echo $bateau['nom_bateau']; ?></option>
                      <?php endforeach; ?>
                  <?php else : ?>
                      <option value="">Aucun bateau disponible</option>
                  <?php endif; ?>
                </select>
